...
namespace midisynth
{
   ...
   public:
      ...
      virtual bool synthesize(int_least32_t *buf, std::size_t samples, float rate,
                              int_least32_t left, int_least32_t right) = 0;
   ...
   {
   public:
      virtual note *note_on(int_least32_t program, int note, int velocity,
                            float frequency_multiplier) = 0;
   protected:
      ~note_factory() {}
   };
   ...
   public:
      ...
      int synthesize(int_least32_t *out, std::size_t samples, float rate,
   ...
   {
   public:
      fm_operator(int AR, int DR, int SR, int RR, int SL, int TL, int KS, int ML,
                  int DT, int AMS, int key);
   ...
   {
   public:
      fm_sound_generator(const FMPARAMETER &params, int note,
                         float frequency_multiplier);
      void set_rate(float rate);
   ...
   {
   public:
      fm_note(const FMPARAMETER &params, int note, int velocity, int panpot,
